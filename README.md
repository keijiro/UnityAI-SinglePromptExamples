## Unity AI Single Prompt Examples

This repository contains examples of game prototypes created primarily from a
single prompt. In practice, I still used a few follow-up prompts to fine-tune
details after the initial generation.
